...
use super::{hollow::Hollow, rotate::Rotate3d, shift_isosurface::ShiftIsosurface, scale::Scale, translate::Translate};
...
pub type Onion<Sdf, Dim> = ShiftIsosurface<Hollow<Sdf, Dim>, Dim>;
